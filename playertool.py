...
# 90s filter
min_90s = st.slider('Minimum 90s played', int(dataf['90s'].min()), int(dataf['90s'].max()))
...
most_similar_player_metrics = df[df['Player'] == most_similar_player_name].iloc[0][selected_columns]
